...
void Door::makingDoor() {
    ...
    modelTransform_cube = glm::translate(modelTransform_cube, glm::vec3(15.0, -cube.CUBE_EDGE_LENGTH / 2, 0.0));
    modelTransform_cube = glm::scale(modelTransform_cube, glm::vec3(0.1, 2.0, 1.0));
    ...
    glUniform3fv(objColorLocation_cube, 1, (float*)&_Color);
